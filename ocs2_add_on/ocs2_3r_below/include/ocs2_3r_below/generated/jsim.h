...
class JSIM : public iit::rbd::StateDependentMatrix<iit::Ballbot::tpl::JointState<typename TRAIT::Scalar>, 3, 3, JSIM<TRAIT>>
{
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    private:
        typedef iit::rbd::StateDependentMatrix<iit::Ballbot::tpl::JointState<typename TRAIT::Scalar>, 3, 3, JSIM<TRAIT>> Base;
    public:
        typedef typename TRAIT::Scalar Scalar;
        typedef typename iit::Ballbot::tpl::JointState<Scalar> JointState;
        typedef iit::rbd::Core<Scalar> CoreS;
        typedef typename Base::Index Index;
        typedef typename iit::rbd::PlainMatrix<Scalar, 3, 3> MatrixType;
    ...
    private:
        ...
        InertiaMatrix link_1_Ic;
        InertiaMatrix link_2_Ic;
        const InertiaMatrix& gripper_Ic;
